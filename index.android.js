...
var Weekdays = React.createClass({
  ...
  /** Render DayItems for the whole week */
  days: function(){
    return DAYS.map(function(day){
      // will be called 1 time for every element in an array (7 times, 1 for each day)
...
// 2) Style the React Component
// styling is made through those objects, syntax and idea similiar to CSS
